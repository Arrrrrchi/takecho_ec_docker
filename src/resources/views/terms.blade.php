...
<section class="container mx-auto min-mx-6 py-8">
    ...
    <div class="text-center">
        ...
        <div class="text-start w-3/4 mx-auto">
    ...
    <div class="md:w-3/4 mx-auto terms px-4">
        <h2 class="text-xl font-bold mt-8 mb-4">第1条 本規約の適用範囲</h2>
        <ul class="list-disc list-inside">
            <li>本規約は、本サービス（第2条に定義）の利用に関する当社と購入会員（第2条に定義）との間の権利義務関係を定めることを目的とし、購入会員と当社の間の本サービスの利用に関わる一切の関係に適用されます。</li>
        ...
        <h2 class="text-xl font-bold mt-8 mb-4">第7条（利用制限および登録抹消）</h2>
        ...
        <h2 class="text-xl font-bold mt-8 mb-4">第9条（サービス内容の変更等）</h2>
        <p>当社は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。</p>

        <h2 class="text-xl font-bold mt-8 mb-4">第10条（利用規約の変更）</h2>
        <p>当社は、必要と判断した場合には、ユーザーに通知することなくいつでも本規約を変更することができるものとします。</p>

        <h2 class="text-xl font-bold mt-8 mb-4">第11条（通知または連絡）</h2>
        <p>ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。</p>

        <h2 class="text-xl font-bold mt-8 mb-4">第12条（権利義務の譲渡の禁止）</h2>
        <p>ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</p>

        <h2 class="text-xl font-bold mt-8 mb-4">第13条（準拠法・裁判管轄）</h2>
